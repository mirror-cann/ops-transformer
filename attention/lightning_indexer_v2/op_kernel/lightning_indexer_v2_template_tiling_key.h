...
/*!
 * \file lightning_indexer_v2_template_tiling_key.h
 * \brief
 */

#ifndef TEMPLATE_TILING_KEY_LI_V2_H_
#define TEMPLATE_TILING_KEY_LI_V2_H_
...
ASCENDC_TPL_ARGS_DECL(LightningIndexerV2, // 算子OpType
                      ...
                      ASCENDC_TPL_UINT_DECL(K_LAYOUT_T, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST,
                                            LI_LAYOUT_BSND, LI_LAYOUT_TND, LI_LAYOUT_PA_BBND),
...
ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_DTYPE_SEL(DT_Q, LI_TPL_FP16), ASCENDC_TPL_DTYPE_SEL(DT_K, LI_TPL_FP16),
                         ...
                         ASCENDC_TPL_UINT_SEL(K_LAYOUT_T, ASCENDC_TPL_UI_LIST, LI_LAYOUT_PA_BBND),
