...
#ifndef FUSED_COPY_L1_TO_L0B_HPP
#define FUSED_COPY_L1_TO_L0B_HPP
...
struct CopyL1ToL0B<ArchTag, NpuArch::Gemm::GemmType<float, layout::zZ, AscendC::TPosition::B1>, NpuArch::Gemm::GemmType<float, layout::nZ, AscendC::TPosition::B2>>{
    ...
    static constexpr uint32_t FLOAT_SIZE_PER_C0_TEMP =  BYTE_PER_C0 / sizeof(Element);
...
struct CopyL1ToL0B<ArchTag, NpuArch::Gemm::GemmType<Element, layout::nN, AscendC::TPosition::B1>, NpuArch::Gemm::GemmType<Element, layout::zN, AscendC::TPosition::B2>>
{
        ...
        LayoutDst const &layoutDst, LayoutSrc const &layoutSrc)
    {
        ...
        loadDataParams.srcStride = layoutSrc.stride(1) / ELE_SIZE_PER_FRACTAL;
        loadDataParams.sid = 0;
        loadDataParams.dstGap = layoutDst.stride(1) / ELE_SIZE_PER_FRACTAL - 1;
        loadDataParams.ifTranspose = true;
...
struct CopyL1ToL0B<ArchTag, NpuArch::Gemm::GemmType<float, layout::nN, AscendC::TPosition::B1>, NpuArch::Gemm::GemmType<float, layout::zN, AscendC::TPosition::B2>>{
    ...
    static constexpr uint32_t FLAOT_SIZE_NUM_PER_C0 = BYTE_PER_C0 / sizeof(Element);
    static constexpr uint32_t ELE_NUM_PER_FRACTAL = BYTE_PER_FRACTAL / sizeof(Element);
        ...
        LayoutDst const &layoutDst, LayoutSrc const &layoutSrc)
    {
        ...
        for (uint32_t i = 0;
            i < NpuArch::Detail::Alignment::CeilDiv<2 * FLAOT_SIZE_NUM_PER_C0>(layoutDst.orgShape(1));
            i++)
        {
...
struct CopyL1ToL0B<ArchTag, NpuArch::Gemm::GemmType<int8_t, layout::nZ, AscendC::TPosition::B1>, NpuArch::Gemm::GemmType<int8_t, layout::zN, AscendC::TPosition::B2>>{
    ...
    static constexpr uint32_t ELE_NUM_PER_C0 = BYTE_PER_C0 / sizeof(Element);
    static constexpr uint32_t INT8_SIZE_NUM_PER_FRACTAL = BYTE_PER_FRACTAL / sizeof(Element);
        ...
        LayoutDst const &layoutDst, LayoutSrc const &layoutSrc)
    {
        ...
        loadDataParams.srcStride = layoutSrc.stride(1) / INT8_SIZE_NUM_PER_FRACTAL / 2;
        loadDataParams.startIndex = 0;
        loadDataParams.dstGap = 1;
        loadDataParams.dstFracGap = 0;
...
struct CopyL1ToL0B<ArchTag, Gemm::GemmType<float, layout::zN, AscendC::TPosition::A1>> {
    ...
    static constexpr uint32_t FLOAT_SIZE_PER_C0 = BYTE_PER_C0 / sizeof(Element);
    static constexpr uint32_t FLOAT_SIZE_PER_FRACTAL = BYTE_PER_FRACTAL / sizeof(Element);
...
struct CopyL1ToL0B<ArchTag, Gemm::GemmType<Element, layout::zN, AscendC::TPosition::A1>> {
        ...
        LayoutDst const &layoutDst, LayoutSrc const &layoutSrc)
    {
        ...
        loadDataParams.startIndex = 0;
        loadDataParams.repeatTimes =
            static_cast<uint16_t>(NpuArch::Detail::Alignment::CeilDiv<ELE_SIZE_PER_C0>(layoutDst.orgShape(1)));
