...
// 模板参数支持的范围定义
ASCENDC_TPL_ARGS_DECL(MixedQuantSparseFlashMla, // 算子OpType
...
ASCENDC_TPL_UINT_DECL(KV_LAYOUT_T, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST,
                       QSMLA_LAYOUT_PA_BBND, QSMLA_LAYOUT_TND, QSMLA_LAYOUT_BSND),
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_UINT_SEL(KV_LAYOUT_T, ASCENDC_TPL_UI_LIST, QSMLA_LAYOUT_PA_BBND, QSMLA_LAYOUT_TND, QSMLA_LAYOUT_BSND),
