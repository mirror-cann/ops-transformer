...
constexpr uint32_t QLIV2_META_SIZE = 1024;
using QLIV2_METADATA_T = int32_t;
...
static_assert(QLIV2_META_SIZE * sizeof(QLIV2_METADATA_T) >= sizeof(detail::Qliv2Metadata));
};
