...
/*!
 * \file sparse_flash_mla_grad_tiling.cpp
 * \brief
 */
...
ASCENDC_EXTERN_C ge::graphStatus TilingPrepareForSparseFlashMlaGrad(gert::TilingParseContext *context)
{
    ...
    auto compileInfoPtr = context->GetCompiledInfo<SparseFlashMlaGradCompileInfo>();
...
IMPL_OP_OPTILING(SparseFlashMlaGrad)
    .Tiling(TilingSparseFlashMlaGrad)
    .TilingParse<SparseFlashMlaGradCompileInfo>(TilingPrepareForSparseFlashMlaGrad); // 向框架注册入口函数
} // namespace smlag
} // namespace optiling
