...
ASCENDC_TPL_ARGS_DECL(MegaMoe,
    ...
    ASCENDC_TPL_UINT_DECL(TILINGKEY_COMBINE_QUANT_OUT_TYPE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST,
...
ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(TILINGKEY_DISPATCH_QUANT_OUT_DTYPE, ASCENDC_TPL_UI_LIST,
            DISPATCH_QUANT_OUT_DTYPE_E5M2, DISPATCH_QUANT_OUT_DTYPE_E4M3FN, DISPATCH_QUANT_OUT_DTYPE_E2M1),
        ASCENDC_TPL_UINT_SEL(TILINGKEY_COMBINE_QUANT_OUT_TYPE, ASCENDC_TPL_UI_LIST,
            COMBINE_QUANT_OUT_TYPE_NO_QUANT, COMBINE_QUANT_OUT_TYPE_E5M2, COMBINE_QUANT_OUT_TYPE_E4M3FN),
