...
#if (ORIG_DTYPE_WEIGHT == DT_INT8 || ORIG_DTYPE_WEIGHT == DT_FLOAT8_E5M2 || ORIG_DTYPE_WEIGHT == DT_FLOAT8_E4M3FN ||   \
...
extern "C" __global__ __aicore__ void Mc2weight_quant_batch_matmul_v2(GM_ADDR x, GM_ADDR weight, GM_ADDR antiquantScale,
...
#define DTYPE_BIAS DTYPE_X
    ...
    if (TILING_KEY_IS(2000020003000004101UL)) {
        static constexpr WqmmConfig wqmmCfg = {false,         false, Mc2QuantType::MX, false, Mc2QuantType::PER_TENSOR,
                                               CubeFormat::NZ};
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg,
                                                       VEC_ANTIQUANT_CONFIG_3);
    } else if (TILING_KEY_IS(2000020001000004101UL)) {
        static constexpr WqmmConfig wqmmCfg = {false,         false, Mc2QuantType::MX, false, Mc2QuantType::PER_TENSOR,
                                               CubeFormat::NZ};
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg,
                                                       VEC_ANTIQUANT_CONFIG_1);
    }
#else
...
// 当前场景不支持c8输出和fp8输入
    ...
    if (TILING_KEY_IS(100300UL)) {
        INVOKE_WEIGHT_QUANT_BMM_OP_REG_BASE_IMPL(Mc2WeightQuantBatchMatmulV2RegBaseKernel, false, false, false,
                                                 Mc2QuantType::PER_GROUP);
    } else if (TILING_KEY_IS(100310UL)) {
        INVOKE_WEIGHT_QUANT_BMM_OP_REG_BASE_IMPL(Mc2WeightQuantBatchMatmulV2RegBaseKernel, false, true, false,
                                                 Mc2QuantType::PER_GROUP);
    } else if (TILING_KEY_IS(100311UL)) {
        INVOKE_WEIGHT_QUANT_BMM_OP_REG_BASE_IMPL(Mc2WeightQuantBatchMatmulV2RegBaseKernel, true, true, false,
                                                 Mc2QuantType::PER_GROUP);
    } else if (TILING_KEY_IS(100301UL)) {
        INVOKE_WEIGHT_QUANT_BMM_OP_REG_BASE_IMPL(Mc2WeightQuantBatchMatmulV2RegBaseKernel, true, false, false,
                                                 Mc2QuantType::PER_GROUP);
        ...
        INVOKE_WEIGHT_QUANT_BMM_OP_REG_BASE_IMPL(Mc2WeightQuantBatchMatmulV2RegBaseKernel, false, false, true,
                                                 Mc2QuantType::PER_GROUP);
    } else if (TILING_KEY_IS(101310UL)) {
        INVOKE_WEIGHT_QUANT_BMM_OP_REG_BASE_IMPL(Mc2WeightQuantBatchMatmulV2RegBaseKernel, false, true, true,
                                                 Mc2QuantType::PER_GROUP);
    } else if (TILING_KEY_IS(101311UL)) {
        INVOKE_WEIGHT_QUANT_BMM_OP_REG_BASE_IMPL(Mc2WeightQuantBatchMatmulV2RegBaseKernel, true, true, true,
                                                 Mc2QuantType::PER_GROUP);
    } else if (TILING_KEY_IS(101301UL)) {
        INVOKE_WEIGHT_QUANT_BMM_OP_REG_BASE_IMPL(Mc2WeightQuantBatchMatmulV2RegBaseKernel, true, false, true,
                                                 Mc2QuantType::PER_GROUP);
    ...
    if (TILING_KEY_IS(2000030004000012100UL)) {
        ...
        static constexpr WqmmConfig wqmmCfg = {
            false, true, Mc2QuantType::PER_CHANNEL, true, Mc2QuantType::PER_TENSOR, CubeFormat::ND};
#if defined(WEIGHT_B8_BRANCH)
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg,
                                                       VEC_ANTIQUANT_CONFIG_0);
#else
        ...
        static constexpr WqmmConfig wqmmCfg = {
            true, true, Mc2QuantType::PER_CHANNEL, true, Mc2QuantType::PER_TENSOR, CubeFormat::ND};
#if defined(WEIGHT_B8_BRANCH)
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg,
                                                       VEC_ANTIQUANT_CONFIG_0);
#else
        ...
        static constexpr WqmmConfig wqmmCfg = {
            false, true, Mc2QuantType::PER_TENSOR, false, Mc2QuantType::PER_TENSOR, CubeFormat::ND};
#if defined(WEIGHT_B8_BRANCH)
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg,
                                                       VEC_ANTIQUANT_CONFIG_0);
#else
        ...
        static constexpr WqmmConfig wqmmCfg = {
            true, true, Mc2QuantType::PER_TENSOR, false, Mc2QuantType::PER_TENSOR, CubeFormat::ND};
#if defined(WEIGHT_B8_BRANCH)
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg,
                                                       VEC_ANTIQUANT_CONFIG_0);
#else
        ...
        static constexpr WqmmConfig wqmmCfg = {
            false, true, Mc2QuantType::PER_TENSOR, true, Mc2QuantType::PER_TENSOR, CubeFormat::ND};
#if defined(WEIGHT_B8_BRANCH)
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg,
                                                       VEC_ANTIQUANT_CONFIG_0);
#else
        ...
        static constexpr WqmmConfig wqmmCfg = {
            true, true, Mc2QuantType::PER_TENSOR, true, Mc2QuantType::PER_TENSOR, CubeFormat::ND};
#if defined(WEIGHT_B8_BRANCH)
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg,
                                                       VEC_ANTIQUANT_CONFIG_0);
#else
        ...
        static constexpr WqmmConfig wqmmCfg = {
            false, false, Mc2QuantType::PER_TENSOR, true, Mc2QuantType::PER_TENSOR, CubeFormat::ND};
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg,
                                                       VEC_ANTIQUANT_CONFIG_3);
    } else if (TILING_KEY_IS(2000030003000021120UL)) {
        static constexpr WqmmConfig wqmmCfg = {
            true, false, Mc2QuantType::PER_TENSOR, true, Mc2QuantType::PER_TENSOR, CubeFormat::ND};
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg,
                                                       VEC_ANTIQUANT_CONFIG_3);
    }
// 下列tiling key只在c8场景和非fp8输入下出现
        ...
        static constexpr WqmmConfig wqmmCfg = {
            false, true, Mc2QuantType::PER_TENSOR, true, Mc2QuantType::PER_CHANNEL, CubeFormat::ND};
#if defined(WEIGHT_B8_BRANCH)
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg,
                                                       VEC_ANTIQUANT_CONFIG_0);
#else
        ...
        static constexpr WqmmConfig wqmmCfg = {
            true, true, Mc2QuantType::PER_TENSOR, true, Mc2QuantType::PER_CHANNEL, CubeFormat::ND};
#if defined(WEIGHT_B8_BRANCH)
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg,
                                                       VEC_ANTIQUANT_CONFIG_0);
#else
...
#define DTYPE_BIAS DTYPE_X
    ...
    if (TILING_KEY_IS(3000240000000001100UL)) {
        INVOKE_WEIGHT_QUANT_BMM_OP_ASW_IMPL(Mc2WeightQuantBatchMatmulV2ASWKernel, false, false,
                                            Mc2QuantType::PER_TENSOR, false, Mc2QuantType::PER_TENSOR);
