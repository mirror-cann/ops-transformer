...
extern "C" __global__ __aicore__ void mat_mul_v3(GM_ADDR aGM, GM_ADDR bGM, GM_ADDR biasGM, GM_ADDR offsetWGM,
                                                 GM_ADDR cGM, GM_ADDR workspaceGM, GM_ADDR tilingGM)
{
    ...
    if (TILING_KEY_IS(10000900009000090000UL)) {
        MMV3_IMPL_CLASS_TRANS(tilingData, tilingGM, false, false, nullptr, Mc2MatmulV3Advanced::Mc2MatmulAswKernel,
                              Mc2MatmulV3Advanced::Mc2MatmulAswBlock, MM_CFG_NO_PRELOAD);
    } else if (TILING_KEY_IS(10000900009000090001UL)) {
        MMV3_IMPL_CLASS_TRANS(tilingData, tilingGM, true, false, nullptr, Mc2MatmulV3Advanced::Mc2MatmulAswKernel,
                              Mc2MatmulV3Advanced::Mc2MatmulAswBlock, MM_CFG_NO_PRELOAD);
    } else if (TILING_KEY_IS(10000900009000090002UL)) {
        MMV3_IMPL_CLASS_TRANS(tilingData, tilingGM, false, true, nullptr, Mc2MatmulV3Advanced::Mc2MatmulAswKernel,
                              Mc2MatmulV3Advanced::Mc2MatmulAswBlock, MM_CFG_NO_PRELOAD);
    } else if (TILING_KEY_IS(10000900009000090003UL)) {
        MMV3_IMPL_CLASS_TRANS(tilingData, tilingGM, true, true, nullptr, Mc2MatmulV3Advanced::Mc2MatmulAswKernel,
                              Mc2MatmulV3Advanced::Mc2MatmulAswBlock, MM_CFG_NO_PRELOAD);
        ...
        Mc2MatmulV3Advanced::MatMulActKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::RowMajor,
                                             layout::RowMajor, layout::RowMajor>(aGM, bGM, biasGM, cGM, nullptr,
                                                                                 tilingData);
    } else if (TILING_KEY_IS(10001900009000090001UL)) {
        GET_TILING_DATA_WITH_STRUCT(Mc2MatMulV3BasicTilingData, tilingData, tilingGM);
        Mc2MatmulV3Advanced::MatMulActKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::ColumnMajor,
                                             layout::RowMajor, layout::RowMajor>(aGM, bGM, biasGM, cGM, nullptr,
                                                                                 tilingData);
    } else if (TILING_KEY_IS(10001900009000090002UL)) {
        GET_TILING_DATA_WITH_STRUCT(Mc2MatMulV3BasicTilingData, tilingData, tilingGM);
        Mc2MatmulV3Advanced::MatMulActKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::RowMajor,
                                             layout::ColumnMajor, layout::RowMajor>(aGM, bGM, biasGM, cGM, nullptr,
                                                                                    tilingData);
        ...
        GET_TILING_DATA_WITH_STRUCT(Mc2MatMulV3BasicTilingData, tilingData, tilingGM);
        Mc2MatmulV3Advanced::MatMulActKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::RowMajor,
                                             layout::RowMajor, layout::RowMajor, B_FULL_LOAD_MODE>(
        ...
        GET_TILING_DATA_WITH_STRUCT(Mc2MatMulV3BasicTilingData, tilingData, tilingGM);
        Mc2MatmulV3Advanced::MatMulActKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::RowMajor,
                                             layout::ColumnMajor, layout::RowMajor, B_FULL_LOAD_MODE>(
            aGM, bGM, biasGM, cGM, nullptr, tilingData);
        ...
        MatMulStreamKActKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::RowMajor, layout::RowMajor,
                               layout::RowMajor, MatMulL0C2Out::ON_THE_FLY>(aGM, bGM, biasGM, cGM, workspaceGM,
                                                                            tilingData);
        ...
        GET_TILING_DATA_WITH_STRUCT(Mc2MatMulV3BasicTilingData, tilingData, tilingGM);
        MatMulStreamKActKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::RowMajor, layout::RowMajor,
                               layout::RowMajor, MatMulL0C2Out::ND_FIXPIPE_1_2>(aGM, bGM, biasGM, cGM, workspaceGM,
                                                                                tilingData);
        ...
        MMV3_IMPL_CLASS_TRANS(tilingData, tilingGM, false, false, workspaceGM,
                              Mc2MatmulV3Advanced::Mc2MatmulStreamKKernel, Mc2MatmulV3Advanced::MatmulStreamKBlock,
        ...
        MMV3_IMPL_CLASS_TRANS(tilingData, tilingGM, false, false, nullptr,
                              Mc2MatmulV3Advanced::MatmulAswKernelAL1FullLoad, Mc2MatmulV3Advanced::Mc2MatmulAswBlock,
                              MM_CFG_NO_PRELOAD);
        ...
        MMV3_IMPL_CLASS_TRANS(tilingData, tilingGM, false, false, nullptr,
                              Mc2MatmulV3Advanced::MatmulAswKernelAL1FullLoad, Mc2MatmulV3Advanced::MatmulDaswBlock,
                              MM_CFG_NO_PRELOAD);
        ...
        MMV3_IMPL_CLASS_TRANS(tilingData, tilingGM, false, false, nullptr,
                              Mc2MatmulV3Advanced::Mc2MatmulAswKernelBL1FullLoad,
                              Mc2MatmulV3Advanced::Mc2MatmulAswBlock, MM_CFG_NO_PRELOAD);
        ...
        MMV3_IMPL_CLASS_TRANS(tilingData, tilingGM, false, false, nullptr,
                              Mc2MatmulV3Advanced::Mc2MatmulAswKernelBL1FullLoad, Mc2MatmulV3Advanced::MatmulDaswBlock,
                              MM_CFG_NO_PRELOAD);
        ...
        MMV3_IMPL_CLASS_TRANS(tilingData, tilingGM, false, false, workspaceGM,
                              Mc2MatmulV3Advanced::Mc2MatmulFixpipeOptiKernel, Mc2MatmulV3Advanced::Mc2MatmulAswBlock,
                              MM_CFG_NO_PRELOAD);
        ...
        Mc2MatmulV3Advanced::MatMulFixpipeOptiActKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::RowMajor,
                                                        layout::RowMajor, layout::RowMajor>(aGM, bGM, biasGM, cGM,
        ...
        Mc2MatmulV3Advanced::MatMulFixpipeOptiActKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::RowMajor,
                                                        layout::ColumnMajor, layout::RowMajor>(aGM, bGM, biasGM, cGM,
                                                                                               workspaceGM, tilingData);
        ...
        MMV3_IMPL_CLASS_TRANS(tilingData, tilingGM, false, false, workspaceGM,
                              Mc2MatmulV3Advanced::Mc2MatmulFixpipeOptiKernel, Mc2MatmulV3Advanced::MatmulDaswBlock,
                              MM_CFG_NO_PRELOAD);
        ...
        MMV3_IMPL_CLASS_TRANS(tilingData, tilingGM, false, false, workspaceGM,
                              Mc2MatmulV3Advanced::Mc2MatmulFixpipeOptiDualDstKernel,
                              Mc2MatmulV3Advanced::Mc2MatmulAswBlock, MM_CFG_NO_PRELOAD);
        ...
        MMV3_IMPL_CLASS_TRANS(tilingData, tilingGM, false, false, nullptr,
                              Mc2MatmulV3Advanced::Mc2MatmulAswKernelABL1FullLoad,
                              Mc2MatmulV3Advanced::Mc2MatmulAswBlock, MM_CFG_NO_PRELOAD);
