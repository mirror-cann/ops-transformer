                                                       ...
                                                       GM_ADDR cGM, GM_ADDR workspaceGM, GM_ADDR tilingGM)
{
    ...
    REGISTER_TILING_FOR_TILINGKEY("TILING_KEY_VAR >= 10001900009000190000UL && TILING_KEY_VAR < 10001900009002090000UL",
                                  BatchMatMulV3IterBatchBasicTilingData);
    REGISTER_TILING_FOR_TILINGKEY("TILING_KEY_VAR >= 10001900009000090000UL && TILING_KEY_VAR < 10001900009000190000UL",
    ...
    if (TILING_KEY_IS(10000900009000090000UL)) {
        ...
        BMMV3_IMPL_CLASS_TRANS(false, false, BatchMatMulV3Advanced::Mc2BatchMatMulMultiBatchKernel,
                               BatchMatMulV3Advanced::Mc2BatchMatMulMultiBatchBaseBlock,
                               MM_CFG_MULTI_BATCH_OUT_BATCH_BIAS);
        ...
        BMMV3_IMPL_CLASS_TRANS(false, false, BatchMatMulV3Advanced::Mc2BatchMatMulMultiBatchKernel,
                               BatchMatMulV3Advanced::Mc2BatchMatMulMultiBatchBaseBlock,
                               MM_CFG_MULTI_BATCH_OUT_SING_BIAS);
        ...
        Mc2BatchMatMulActIterBatchKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::RowMajor, layout::RowMajor,
                                         layout::RowMajor>(aGM, bGM, biasGM, cGM, workspaceGM, tilingData);
    } else if (TILING_KEY_IS(10001900009000190001UL)) {
        GET_TILING_DATA_WITH_STRUCT(BatchMatMulV3IterBatchBasicTilingData, tilingData, tilingGM);
        Mc2BatchMatMulActIterBatchKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::ColumnMajor, layout::RowMajor,
                                         layout::RowMajor>(aGM, bGM, biasGM, cGM, workspaceGM, tilingData);
    } else if (TILING_KEY_IS(10001900009000190002UL)) {
        GET_TILING_DATA_WITH_STRUCT(BatchMatMulV3IterBatchBasicTilingData, tilingData, tilingGM);
        Mc2BatchMatMulActIterBatchKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::RowMajor, layout::ColumnMajor,
                                         layout::RowMajor>(aGM, bGM, biasGM, cGM, workspaceGM, tilingData);
        ...
        Mc2BatchMatMulActIterBatchKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::ColumnMajor,
                                         layout::ColumnMajor, layout::RowMajor>(aGM, bGM, biasGM, cGM, workspaceGM,
                                                                                tilingData);
