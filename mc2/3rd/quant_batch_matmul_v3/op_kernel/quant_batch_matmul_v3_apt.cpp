                                                            ...
                                                            GM_ADDR workSpace, GM_ADDR tiling)
{
    ...
    if (TILING_KEY_IS(2000)) {
        ...
        QUANT_BMMV3_IMPL_CLASS(format_x1, format_x2, format_y, false, false,
                               Mc2QuantBatchMatmulV3::Mc2QuantBmmPertokenAL1FullLoad,
                               Mc2QuantBatchMatmulV3::Mc2QuantBmmAswBlock, MM_CFG_NO_PRELOAD_OPEN_UNIT_FLAG);
    ...
    if (TILING_KEY_IS(4000)) {
        Mc2QuantBatchMatmulV3::MatMulPerBlockASW<DTYPE_X1, DTYPE_X2, DTYPE_BIAS, DTYPE_Y, format_x1, format_x2,
                                                 format_y, false, false>
            op;
        op.Init(x1, x2, bias, scale, pertokenScale, y, user1, &tilingData, &tPipe);
        op.Process();
