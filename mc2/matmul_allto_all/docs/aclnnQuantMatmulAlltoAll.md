...
* 通信约束：
   ...
   - <term>Ascend 950PR/Ascend 950DT</term>：支持CCU通信。由于CCU通信域存在限制，可能出现HCCL集合通信库自动降级使用AI\_CPU通信引擎从而导致报错的场景，如出现此种报错请使用aclnnQuantMatmulAlltoAllV2接口，并指定commMode参数为ai\_cpu。
