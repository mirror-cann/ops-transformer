...
# ----------------------------------------------------------------------------
__golden__ = {"kernel": {"quant_reduce_scatter": "quant_reduce_scatter_golden"}}
...
def quant_reduce_scatter_golden(
    ...
    **kwargs,
    ...
    output_dtype_map = {0: torch.float16, 1: torch.bfloat16, 2: torch.float32}
    ...
    scatter_output = reduced_output[
        rank * scatter_shape_m : (rank + 1) * scatter_shape_m, :
    ]
