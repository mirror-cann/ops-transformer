...
def _kv_compress_epilog(cache: torch.Tensor, x: torch.Tensor, slot_mapping: torch.Tensor, *,
...
def kv_compress_epilog(cache: torch.Tensor, x: torch.Tensor, slot_mapping: torch.Tensor, *,
    ...
    return torch.ops.cann_ops_transformer.kv_compress_epilog(
        cache, x, slot_mapping, quant_group_size=quant_group_size,
        quant_mode=quant_mode, round_scale=round_scale, x_scale=x_scale)