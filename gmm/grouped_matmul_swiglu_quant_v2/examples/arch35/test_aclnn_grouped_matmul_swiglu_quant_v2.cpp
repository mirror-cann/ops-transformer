...
int aclnnGroupedMatmulSwigluQuantV2Test(int32_t deviceId, aclrtStream &stream)
{
    ...
    ret = CreateAclTensor<uint8_t>(xHostDataUnsigned, xShape, &xDeviceAddr, aclDataType::ACL_FLOAT8_E5M2,
    ...
    ret = CreateAclTensorList<int8_t>(weightHostDataList, weightShapeList, &weightDeviceAddr,
                                      aclDataType::ACL_FLOAT8_E5M2, &weight);
    ...
    ret = CreateAclTensorList<int8_t>(weightScaleHostDataList, weightScaleShapeList, &weightScaleDeviceAddr,
                                      aclDataType::ACL_FLOAT8_E8M0, &weightScale);
    ...
    // 创建xScale aclTensor
    ret = CreateAclTensor<int8_t>(xScaleHostData, xScaleShape, &xScaleDeviceAddr, aclDataType::ACL_FLOAT8_E8M0,
    ...
    // 创建y aclTensor
    ret = CreateAclTensor<int8_t>(outputHostData, outputShape, &outputDeviceAddr, aclDataType::ACL_FLOAT8_E5M2,
    ...
    // 创建yScale aclTensor
    ret = CreateAclTensor<int8_t>(outputScaleHostData, outputScaleShape, &outputScaleDeviceAddr,
    ...
    ret = aclnnGroupedMatmulSwigluQuantV2GetWorkspaceSize(
        ...
        groupListType, nullptr, output, outputScale, &workspaceSize, &executor);
