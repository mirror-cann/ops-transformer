...
#define WQGMM_MTE2_INNER_SIZE_256_BUF_NUM_2 6
...
#define WQGMM_NOT_SINGLE_MULTI_SINGLE 0
#define WQGMM_SINGLE_MULTI_SINGLE 1
...
ASCENDC_TPL_ARGS_DECL(
    ...
    ASCENDC_TPL_UINT_DECL(OFFSET_OR_BIAS_EXIT, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST,
                          ...
                          WQGMM_ANTIQUANT_OFFSET_EXIST_BIAS_FP32_EXIST),
    ...
    ASCENDC_TPL_UINT_DECL(TEMPLATE_CUSTOM_SC, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST,
                          WQGMM_MTE2_INNER_SIZE_512_BUF_NUM_2, WQGMM_MTE2_INNER_SIZE_512_BUF_NUM_4,
                          WQGMM_MTE2_INNER_SIZE_1024_BUF_NUM_2, WQGMM_MTE2_INNER_SIZE_256_BUF_NUM_4,
                          WQGMM_MTE2_INNER_SIZE_512_BUF_NUM_DEFAULT, WQGMM_MTE2_INNER_SIZE_384_BUF_NUM_3,
                          WQGMM_MTE2_INNER_SIZE_256_BUF_NUM_2, WQGMM_MTE2_INNER_SIZE_DYNAMIC_BUF_NUM_4),
    ASCENDC_TPL_BOOL_DECL(IS_SINGLE_MULTI_SINGLE, WQGMM_SINGLE_MULTI_SINGLE, WQGMM_NOT_SINGLE_MULTI_SINGLE),
...
ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_BOOL_SEL(IS_SINGLE_MULTI_SINGLE, WQGMM_NOT_SINGLE_MULTI_SINGLE),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(TEMPLATE_CUSTOM_SC, ASCENDC_TPL_UI_LIST, WQGMM_MTE2_INNER_SIZE_256_BUF_NUM_4,
                             WQGMM_MTE2_INNER_SIZE_DYNAMIC_BUF_NUM_4),
        ASCENDC_TPL_BOOL_SEL(IS_SINGLE_MULTI_SINGLE, WQGMM_SINGLE_MULTI_SINGLE, WQGMM_NOT_SINGLE_MULTI_SINGLE),
        ASCENDC_TPL_UINT_SEL(ALGORITHM_SUB_CATEGORY, ASCENDC_TPL_UI_LIST, WQGMM_N_FIRST_TAIL_RESPLIT),
        ASCENDC_TPL_UINT_SEL(ALGORITHM_CATEGORY, ASCENDC_TPL_UI_LIST, WQGMM_VECTOR_ANTIQUANT)),
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(W_TYPE, ASCENDC_TPL_UI_LIST, WQGMM_ND),
        ASCENDC_TPL_UINT_SEL(OFFSET_OR_BIAS_EXIT, ASCENDC_TPL_UI_LIST, WQGMM_ANTIQUANT_OFFSET_NOT_EXIST_BIAS_NOT_EXIST,
                             WQGMM_ANTIQUANT_OFFSET_EXIST_BIAS_NOT_EXIST),
        ASCENDC_TPL_UINT_SEL(C_QUANT_TYPE, ASCENDC_TPL_UI_LIST, WQGMM_NONE),
        ASCENDC_TPL_UINT_SEL(W_QUANT_TYPE, ASCENDC_TPL_UI_LIST, WQGMM_PER_GROUP),
        ASCENDC_TPL_UINT_SEL(WQ_B_TRANS, ASCENDC_TPL_UI_LIST, WQGMM_NO_TRANS, WQGMM_TRANS),
        ASCENDC_TPL_UINT_SEL(WQ_A_TRANS, ASCENDC_TPL_UI_LIST, WQGMM_NO_TRANS),
        ASCENDC_TPL_UINT_SEL(TEMPLATE_CUSTOM_SC, ASCENDC_TPL_UI_LIST, WQGMM_MTE2_INNER_SIZE_256_BUF_NUM_2),
        ASCENDC_TPL_BOOL_SEL(IS_SINGLE_MULTI_SINGLE, WQGMM_NOT_SINGLE_MULTI_SINGLE),
        ASCENDC_TPL_UINT_SEL(ALGORITHM_SUB_CATEGORY, ASCENDC_TPL_UI_LIST, WQGMM_N_FIRST_BASIC_BLOCK),
        ASCENDC_TPL_UINT_SEL(ALGORITHM_CATEGORY, ASCENDC_TPL_UI_LIST, WQGMM_VECTOR_ANTIQUANT)));
#endif
